...
#define AK_USER_WATCHDOG_SIG (AK_USER_DEFINE_SIG - 2)
#define TSM_EOT_SIGNAL		 (AK_USER_DEFINE_SIG - 1)

#define AK_TIMER_UNIT (100) /* 100 ms */
...
#define TaskPostPureMsg(i, s)	 		task_post_pure_msg(i, s)
#define TaskPostCommonMsg(i, s, d, l)	task_post_common_msg(i, s, d, l)
#define TaskPostDynamicMsg(i, s, d, l)	task_post_dynamic_msg(i, s, d, l)

#define TimerSet(i, s, d, p)			timer_set(i, s, d, p)
#define TimerRm(i, s)					timer_remove_attr(i, s)
